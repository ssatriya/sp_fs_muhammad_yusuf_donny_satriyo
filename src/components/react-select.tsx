...
const selectStyles = {
  ...
  placeholderStyles: "text-muted-foreground text-sm",
  ...
  noOptionsMessageStyles:
    "text-muted-foreground py-4 text-center text-sm rounded-sm",
  ...
  loadingMessageStyles: "text-accent-foreground p-1.5",
};
